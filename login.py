...
class LoginScreen:
    def __init__(self):
        ...
        self.login_button = ctk.CTkButton(self.root, text='Login', corner_radius=12, bg_color='#2b2b2b',
                                          ...
                                          hover_color='dark green', text_color='white')
...
class Register:
    def __init__(self):
        ...
        self.register_button = ctk.CTkButton(self.root, text='Register', corner_radius=12, bg_color='#2b2b2b',
                                          width=200, height=35, font=('Arial bold', 18), command=self.analyze_credentials)
    ...
    def analyze_credentials(self):
        ...
        if not self.is_username_registeres(username) and len(username) > 4:
            requirements[0] = 1
        elif self.is_username_registeres(username):
    ...
    @staticmethod
    def is_username_registeres(username):
